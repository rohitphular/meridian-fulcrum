...
import database.upsert as upsert_db
from database.job_state import bootstrap_job_state, read_last_sheet_modified_at, update_ran_at, upsert_job_state
...
class LedgerExtractJob:
    ...
    def run(self, config: dict[str, Any]) -> None:
        # --- Phase 1: Job state ---
        bootstrap_job_state(self._conn)
        ...
        # --- Phase 3: Finalise ---
        upsert_job_state(self._conn, current_sheet_modified_at)
