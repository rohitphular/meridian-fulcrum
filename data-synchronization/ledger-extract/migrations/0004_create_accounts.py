    ...
    with client.cursor() as cursor:
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS account_master (
                ...
                opening_amount_local_value NUMERIC(19,6) NOT NULL,
                opening_amount_base_value  NUMERIC(19,6) NOT NULL,
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS account_deposit_details (
                ...
                entity_type                   TEXT,
                entity_id                     UUID,
                current_balance_local_value   NUMERIC(19,6) NOT NULL,
                current_balance_base_value    NUMERIC(19,6) NOT NULL,
                local_currency                CHAR(3)       NOT NULL,
                base_currency                 CHAR(3)       NOT NULL,
                currency_rate_ref             UUID,
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS account_market_investment_details (
                ...
                entity_type               TEXT,
                entity_id                 UUID,
                current_value_local_value NUMERIC(19,6) NOT NULL,
                current_value_base_value  NUMERIC(19,6) NOT NULL,
                cost_basis_local_value    NUMERIC(19,6),
                cost_basis_base_value     NUMERIC(19,6),
                units_held                NUMERIC(19,6),
                unit_value_local_value    NUMERIC(19,6),
                unit_value_base_value     NUMERIC(19,6),
                unit_type                 TEXT,
                local_currency            CHAR(3)       NOT NULL,
                base_currency             CHAR(3)       NOT NULL,
                currency_rate_ref         UUID,
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS account_fixed_income_details (
                ...
                entity_type                   TEXT,
                entity_id                     UUID,
                face_value_local_value        NUMERIC(19,6) NOT NULL,
                face_value_base_value         NUMERIC(19,6) NOT NULL,
                purchase_price_local_value    NUMERIC(19,6) NOT NULL,
                purchase_price_base_value     NUMERIC(19,6) NOT NULL,
                current_value_local_value     NUMERIC(19,6) NOT NULL,
                current_value_base_value      NUMERIC(19,6) NOT NULL,
                local_currency                CHAR(3)       NOT NULL,
                base_currency                 CHAR(3)       NOT NULL,
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS account_property_details (
                ...
                current_value_local_value           NUMERIC(19,6) NOT NULL,
                current_value_base_value            NUMERIC(19,6) NOT NULL,
                monthly_rental_income_local_value   NUMERIC(19,6),
                monthly_rental_income_base_value    NUMERIC(19,6),
                local_currency                      CHAR(3)       NOT NULL,
                base_currency                       CHAR(3)       NOT NULL,
                currency_rate_ref                   UUID,
                purchase_date                       DATE,
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS account_p2p_lending_details (
                ...
                entity_type                 TEXT,
                entity_id                   UUID,
                principal_lent_local_value  NUMERIC(19,6) NOT NULL,
                principal_lent_base_value   NUMERIC(19,6) NOT NULL,
                current_value_local_value   NUMERIC(19,6) NOT NULL,
                current_value_base_value    NUMERIC(19,6) NOT NULL,
                local_currency              CHAR(3)       NOT NULL,
                base_currency               CHAR(3)       NOT NULL,
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS account_revolving_credit_details (
                ...
                entity_type                     TEXT,
                entity_id                       UUID,
                credit_limit_local_value        NUMERIC(19,6) NOT NULL,
                credit_limit_base_value         NUMERIC(19,6) NOT NULL,
                current_balance_local_value     NUMERIC(19,6) NOT NULL,
                current_balance_base_value      NUMERIC(19,6) NOT NULL,
                minimum_payment_local_value     NUMERIC(19,6),
                minimum_payment_base_value      NUMERIC(19,6),
                local_currency                  CHAR(3)       NOT NULL,
                base_currency                   CHAR(3)       NOT NULL,
                currency_rate_ref               UUID,
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS account_installment_loan_details (
                ...
                entity_type                           TEXT,
                entity_id                             UUID,
                original_principal_amount_local_value NUMERIC(19,6) NOT NULL,
                original_principal_amount_base_value  NUMERIC(19,6) NOT NULL,
                outstanding_balance_local_value       NUMERIC(19,6) NOT NULL,
                outstanding_balance_base_value        NUMERIC(19,6) NOT NULL,
                monthly_payment_local_value           NUMERIC(19,6) NOT NULL,
                monthly_payment_base_value            NUMERIC(19,6) NOT NULL,
                local_currency                        CHAR(3)       NOT NULL,
                base_currency                         CHAR(3)       NOT NULL,
                currency_rate_ref                     UUID,
                interest_rate                         NUMERIC(8,4)  NOT NULL,
