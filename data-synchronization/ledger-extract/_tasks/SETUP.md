...
│   └── subscriptions.py     # write-back helpers: write_back_success() (5 cols starting at col 14), write_back_failure() (3 cols starting at col 15), flush()
├── database/
...
│   └── subscriptions.py             # subscription_master upserts; re-uses load_account_map from transactions
└── migrations/
    ...
    ├── 0009_rename_currency_rate_ref_to_currency_rate_id.py  # rename column on account_master, 7 extension tables, transaction_master
    └── 0010_create_subscriptions.py          # subscription_master
```
